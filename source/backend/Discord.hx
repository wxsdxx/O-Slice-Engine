...
class DiscordClient
{
	...
	private inline static final _defaultID:String = "1299570379035119676";
	...
	public static function changePresence(details:String = 'Ready to Rap!', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
